...
public class TrainerController {
	...
	public ModelAndView getTrainerDetails(@RequestParam Map<String,String>param){		
		Connection con=DBConnection.getConnection();
        String trainer=param.get("trainer");
        toUpdate=trainer;
        ArrayList<String>courses=new ArrayList<String>();
        ...
        try{
        	...
        	while(set.next()){
        		...
        		phone=Long.parseLong(set.getString(3));
        	    exp=set.getInt(4);
        ...
        model.put("phone",phone);
        model.put("exp", exp);
        return new ModelAndView("TrainerDetails","model",model);
	}
	...
	public ModelAndView searchTrainer(){
        ...
        System.out.println(trainers);
        return new ModelAndView("searchTrainer","model",trainers);
	}
}
